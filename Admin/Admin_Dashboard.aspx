        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                <div class="nav-section">
                    ...
                    <a href="Groups.aspx" class="nav-link">
                        <i class="fa-solid fa-user-group"></i> Groups
                    </a>
                    <a href="Projects.aspx" class="nav-link">
                        <i class="fa-solid fa-folder-open"></i> Projects
                    </a>
                    <a href="Technologies.aspx" class="nav-link">
                    ...
                    <div class="stats-grid">
                        <div class="stat-card">
                            ...
                            <div class="stat-value">
                                <asp:Label ID="lblTotalUsers" runat="server" Text="1,248"></asp:Label>
                            </div>
                        ...
                        <div class="stat-card">
                            ...
                            <div class="stat-value">
                                <asp:Label ID="lblTotalGroups" runat="server" Text="156"></asp:Label>
                            </div>
                        ...
                        <div class="stat-card">
                            ...
                            <div class="stat-value">
                                <asp:Label ID="lblPendingProjects" runat="server" Text="84"></asp:Label>
                            </div>
                        ...
                        <div class="stat-card">
                            ...
                            <div class="stat-value">
                                <asp:Label ID="lblTotalTech" runat="server" Text="32"></asp:Label>
                            </div>
                    ...
                    <div class="data-section">
                        <div class="section-header">
                            ...
                            <div class="section-actions">
                                <a href="Projects.aspx" class="btn-secondary" style="text-decoration:none; display:inline-block;">View All</a>
                            </div>
                        </div>
