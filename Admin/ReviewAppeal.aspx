    ...
    <aside class="sidebar">
        ...
        <div class="sidebar-footer">
            <div class="user-profile">
                ...
                <div class="user-info">
                    <h4><%= Server.HtmlEncode(string.IsNullOrEmpty(Convert.ToString(Session["FullName"])) ? "User" : Convert.ToString(Session["FullName"])) %></h4>
                    <p><%= Server.HtmlEncode(string.IsNullOrEmpty(Convert.ToString(Session["Email"])) ? "user@example.com" : Convert.ToString(Session["Email"])) %></p>
                </div>
            </div>
        </div>
    </aside>
