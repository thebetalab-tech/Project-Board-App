...
namespace Project_Board.Admin
{
    public partial class RejectionForm : System.Web.UI.Page
    {
        ...
        {
            string type = Request.QueryString["type"];
            if (type == "Project") Response.Redirect("Admin_ProjectsManagement.aspx");
            else if (type == "Task" || type == "Appeal") Response.Redirect("Admin_TaskManagement.aspx");
            else if (type == "Group") Response.Redirect("Admin_GroupsManagement.aspx");
            else Response.Redirect("Admin_Dashboard.aspx");
        }
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connString))
            {
                ...
                string redirectUrl = "Admin_Dashboard.aspx";
                ...
                if (type == "Project")
                {
                    ...
                    redirectUrl = "Admin_ProjectsManagement.aspx";
                }
                else if (type == "Task")
                {
                    // Update Task Status
                    ...
                    redirectUrl = "Admin_TaskManagement.aspx";
                }
                else if (type == "Appeal")
                {
