    ...
    <form id="form1" runat="server">
        ...
        <div class="onboarding-container">
            <div class="onboarding-header">
                <h1 class="onboarding-title">Welcome to <span class="brand-word brand-word--board">Project Board</span></h1>
                <p class="onboarding-subtitle">How would you like to proceed?</p>
            </div>

            <div class="onboarding-cards">
                
                <asp:LinkButton ID="btnStartGroup" runat="server" CssClass="onboarding-card" OnClick="btnStartGroup_Click">
                ...
                <asp:LinkButton ID="btnJoinGroup" runat="server" CssClass="onboarding-card" OnClick="btnJoinGroup_Click">
                    <div class="card-icon-wrapper">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
                            <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" />
                            <circle cx="9" cy="7" r="4" />
