                ...
                <asp:Panel ID="pnlSignupForm" runat="server">
                    ...
                    <div class="input-group" id="enrollmentGroup">
                        ...
                        <div class="input-wrapper">
                            ...
                            <asp:TextBox ID="enrollment" runat="server" ClientIDMode="Static" CssClass="form-input" placeholder="e.g. 24020201071" MaxLength="11" required="required"></asp:TextBox>
                        </div>
                        ...
                        <div class="help-text" style="font-size: 0.75rem; color: #64748b; margin-top: 0.5rem;">
                            ...
                            <strong>Requirement:</strong> 11-digit enrollment number (e.g., 24020201071)
                        </div>
                    </div>
