        ...
        <div class="form-side">
            <div class="form-side-content">
                ...
                <form id="signupForm" runat="server" class="login-form" autocomplete="off">
                    <asp:Label ID="lblMessage" runat="server" EnableViewState="false" CssClass="form-message"></asp:Label>
                    ...
                    <div class="input-group" id="nameGroup">
                        ...
                        <div class="input-wrapper">
                            ...
                            <asp:TextBox ID="fullName" runat="server" ClientIDMode="Static" placeholder="Enter your full name" required="required"></asp:TextBox>
                        </div>
                    </div>
                    ...
                    <div class="input-group" id="emailGroup">
                        ...
                        <div class="input-wrapper">
                            ...
                            <asp:TextBox ID="loginId" runat="server" ClientIDMode="Static" TextMode="Email" placeholder="Enter your email" required="required"></asp:TextBox>
                        </div>
                    </div>
                    ...
                    <div class="input-group" id="enrollmentGroup">
                        ...
                        <div class="input-wrapper">
                            ...
                            <asp:TextBox ID="enrollment" runat="server" ClientIDMode="Static" placeholder="Enter your enrollment number" required="required"></asp:TextBox>
                        </div>
                    </div>
                    ...
                    <div class="input-group" id="passwordGroup">
                        ...
                        <div class="input-wrapper">
                            ...
                            <asp:TextBox ID="password" runat="server" ClientIDMode="Static" TextMode="Password" placeholder="Create a password" required="required"></asp:TextBox>
                        </div>
                    </div>
                    ...
                    <div class="input-group" id="confirmPasswordGroup">
                        ...
                        <div class="input-wrapper">
                            ...
                            <asp:TextBox ID="confirmPassword" runat="server" ClientIDMode="Static" TextMode="Password" placeholder="Confirm your password" required="required"></asp:TextBox>
                        </div>
                    </div>

                    <asp:LinkButton ID="loginBtn" runat="server" ClientIDMode="Static" CssClass="login-btn" OnClick="loginBtn_Click" style="margin-top: 10px;">
