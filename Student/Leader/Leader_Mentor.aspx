<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Leader_Mentor.aspx.cs"
    Inherits="Project_Board.Student.Leader.Leader_Mentor" %>
    <!DOCTYPE html>
    <html lang="en">
                ...
                <div class="dashboard-container">
                    ...
                    <div class="data-section">
                        ...
                        <div style="padding: 1.5rem;">
                            <p style="color: var(--c-text-muted); margin-bottom: 1.5rem; font-size: 0.875rem;">Select
                                your faculty mentor. Note: you can only have one active request outstanding. If your
                                request is pending, you must withdraw it to request a different mentor.</p>
