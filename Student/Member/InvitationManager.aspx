<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvitationManager.aspx.cs"
    Inherits="Project_Board.Student.Member.InvitationManager" %>
    <!DOCTYPE html>
    <html lang="en">
                ...
                <div class="dashboard-container">
                    ...
                    <asp:Panel ID="pnlInvitations" runat="server" CssClass="data-section" Visible="false">
                        <div class="section-header">
                            <h2>Pending Invitations <span class="badge"
                                    style="background: var(--c-blue); color: white;">New</span></h2>
                        </div>
                            ...
                            <table>
                                ...
                                <tbody>
                                    <asp:Repeater ID="rptInvitations" runat="server"
                                        OnItemCommand="rptInvitations_ItemCommand">
                                        <ItemTemplate>
                                            <tr>
                                                <td>
                                                    <div class="user-cell">
                                                        <div class="user-cell-avatar"><i class="fa-solid fa-layer-group"
                                                                style="color: var(--c-text-muted);"></i></div>
                                                        <div class="user-cell-info">
                                                            <h4>
                                                                <%# Eval("GroupName") %>
                                                            </h4>
                                                            <p>Leader: <%# Eval("LeaderName") %>
                                                            </p>
                                                        </div>
                                                    </div>
                                                </td>
                    ...
                    <asp:Panel ID="pnlEmptyState" runat="server" CssClass="data-section"
                        ...
                        <p style="color: var(--c-text-muted); margin-bottom: 2rem;">You do not have any incoming group
                            invitations from leaders right now.</p>
                    </asp:Panel>
                </div>
            </main>
        </form>
