<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Member_Team.aspx.cs"
    Inherits="Project_Board.Student.Member.Member_Team" %>
    <!DOCTYPE html>
    <html lang="en">
            ...
            <aside class="sidebar">
                ...
                <div class="sidebar-footer">
                    <div class="user-profile">
                        ...
                        <div class="user-info">
                            <h4>
                                <%= Session["FullName"] ?? "Student Member" %>
                            </h4>
                            <p>
                ...
                <div class="dashboard-container">
                    ...
                    <div class="data-section">
                        ...
                        <div style="padding: 1.5rem;">
                            <p style="color: var(--c-text-muted); margin-bottom: 1.5rem; font-size: 0.875rem;">Current
                                status of your team's faculty mentor request. Only the Team Leader has permissions to
                                select or change mentors.</p>

                            <div
                                style="background: var(--c-bg-elevated); border: 1px solid var(--c-border); padding: 1.5rem; border-radius: 8px;">
                                <h4
                                    style="color: var(--c-text-muted); margin-bottom: 0.5rem; display: flex; align-items: center; gap: 0.5rem;">
                                    <i class="fa-solid fa-user-slash"></i> No Mentor Requested
                                </h4>
                                <p style="font-size: 0.85rem; color: var(--c-text-muted);">Your team leader hasn't
                                    submitted a faculty mentor request yet. Once submitted, status updates will show
                                    here.</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="table-responsive">
                            <asp:Panel ID="pnlUnassigned" runat="server">
                                <div
                                    ...
                                    <p style="font-size: 0.85rem; color: var(--c-text-muted);">You haven't joined a team
                                        yet. Once you join a team, your roster members will appear here.</p>
                                </div>
                            </asp:Panel>
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td style="text-align: right;">
                                                        <span
                                                            class='<%# Eval("Role").ToString() == "Leader" ? "badge admin" : "badge student" %>'>
                                                            <%# Eval("Role") %>
                                                        </span>
                                                    </td>
                                                </tr>
