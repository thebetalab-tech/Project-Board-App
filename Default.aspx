<%@ Page Title="Project Board - Login" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Project_Board._Default" %>
                ...
                <div class="login-form" id="loginForm">
                    ...
                    <div class="input-group" id="emailGroup">
                        ...
                        <div class="input-wrapper">
                            ...
                            <asp:TextBox ID="txtLoginID" runat="server" ClientIDMode="Static" CssClass="form-input" placeholder="Enter your email or username"></asp:TextBox>
                        </div>
                    </div>
                    ...
                    <asp:LinkButton ID="loginBtn" runat="server" ClientIDMode="Static" CssClass="login-btn" OnClick="loginBtn_Click">
