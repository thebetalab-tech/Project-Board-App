        ...
        <div class="forget-wrapper">
            ...
            <asp:Panel ID="pnlPasswordStep" runat="server" Visible="false">
                ...
                <div class="form-group" style="position:relative;">
                    ...
                    <asp:TextBox ID="txtNewPassword" runat="server" CssClass="form-control" placeholder="At least 8 characters" TextMode="Password" required="required" style="padding-right:40px;"></asp:TextBox>
                ...
                <div class="form-group" style="position:relative;">
                    ...
                    <asp:TextBox ID="txtConfirmPassword" runat="server" CssClass="form-control" placeholder="Confirm your new password" TextMode="Password" required="required" style="padding-right:40px;"></asp:TextBox>
                    <button type="button" class="password-toggle" aria-label="Toggle password visibility" style="position:absolute; right:10px; top:35px; background:none; border:none; color:var(--text-secondary, #666); cursor:pointer;">
                        <svg class="eye-icon eye-open" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" width="18" height="18">
                            <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z" />
                            <circle cx="12" cy="12" r="3" />
